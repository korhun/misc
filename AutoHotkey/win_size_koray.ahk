...
snap_window(left, top, w, h) {
    ...
    height0 := (MonitorWorkAreaBottom - MonitorWorkAreaTop)
    width0 := (MonitorWorkAreaRight - MonitorWorkAreaLeft)

	height := height0*h	
    width := width0*w
	
    posX  := MonitorWorkAreaLeft + (left) * width0
    posY  := MonitorWorkAreaTop + (top) * height0
...
snap_window_static(left, top, w, h) {
    ...
    posX  := MonitorWorkAreaLeft + (left) + 10
    posY  := MonitorWorkAreaTop + (top) 
